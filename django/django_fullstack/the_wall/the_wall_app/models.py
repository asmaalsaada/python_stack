...
class Messages(models.Model):
    user_id = models.ForeignKey(Users, related_name="u_msg", on_delete=models.CASCADE)
    message = models.TextField(default="Put your message here")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

class Comments(models.Model):
    message_id = models.ForeignKey(Messages, related_name="msg_cmnt", on_delete=models.CASCADE)
    user_id = models.ForeignKey(Users, related_name="u_cmnt", on_delete=models.CASCADE)
